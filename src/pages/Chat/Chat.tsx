...
<h4 className=" mt-3 mb-3">Messages</h4>



<form className=' relative'>
                  
                  <input style={{ background:them.Navsheet }}  className=" h-10 w-full rounded-full p-3 ints" id="serch" placeholder="         Search here..."/>
                  <SearchIcon   style={{ position:"absolute",right:290,top:10,color:"white" }}/>
</form>
