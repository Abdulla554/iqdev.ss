...
function StudentDetails1() {
  ...
  return (
    <div className=" flex">
    <SidBar/>
    <div  className="px-7 mt-[37px]" style={{ color:them.fontColor, width:1250  }}>
...
<button style={{ background:them.Navsheet,color:them.fontColor  }} className="  ml-[1070px] mt-3  "><MoreHorizIcon/> </button>
...
<div className=" px-4 h-[730px]" style={{ color:them.fontColor , background:them.card}}   >
...
<select  style={{ color:them.button , background:them.card}} className="vf2 w-36 h-10 pl-6 rounded-full ">
...
<select  style={{ color:them.fontColor , background:them.card}} className="vf1 w-36 h-10 pl-6 rounded-full ">
        ...
        {[1,2,3,4,5,4].map((e, i) => {
          return (
            <div className=" flex items-center">
             ...
             <div className=" ">
              <button  style={{ background: them.SidBar, color:them.button }}>
                <CallIcon  />
                </button>
                <button  style={{ background: them.SidBar, color:them.button }}>
              <MailOutlineIcon  />
