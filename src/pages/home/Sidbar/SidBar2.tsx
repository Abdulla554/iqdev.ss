...
<button style={{ background:them.gray}} className=' rounded-full w-10 h-10 pt-2   text-center  '><NotificationsIcon style={{ marginLeft:-11 ,marginTop:-5}}/> </button>
<button style={{ background:them.gray}} className=' rounded-full w-10 h-10 pt-2  text-center  '><SettingsIcon style={{ marginLeft:-11 ,marginTop:-5}}/></button>
...
className='iconmass  rounded-full w-5 h-10 mt-2 ml-9   text-center'>
  <AddIcon style={{ marginLeft:-12 ,marginTop:-9}}/>
  </button>
...
<button style={{ color:them.fontColor,background:them.SidBar}} className='iconmass  rounded-full w-0 h-10   text-center'>
  <EmailIcon fontSize='small' style={{ marginLeft:-10 ,marginTop:-9}} />
  </button>
